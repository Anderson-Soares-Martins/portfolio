...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-white dark:bg-background font-sans lg:px-10"
      ref={containerRef}
    >
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col lg:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm lg:w-full">
              <div className="h-10 absolute left-3 lg:left-3 w-10 rounded-full bg-white dark:bg-background flex items-center justify-center">
