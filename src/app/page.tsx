...
export default function Home() {
  return (
    ...
    >
      ...
      <div className="z-10 flex flex-col justify-center items-center gap-y-8 sm:gap-y-16">
        ...
        <Link href="/about">
          <Button className="px-8 py-4 sm:px-12 sm:py-6 md:px-16 md:py-8 rounded-full shadow-xl text-white font-bold text-base sm:text-xl">
            GET STARTED
          </Button>
        </Link>
      </div>
